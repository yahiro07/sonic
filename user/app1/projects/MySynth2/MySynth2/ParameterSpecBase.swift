...
@resultBuilder struct ParameterGroupBuilder {
  static func buildBlock(_ nodes: [NodeSpec]...) -> [NodeSpec] { nodes.flatMap { $0 } }
  static func buildExpression(_ node: NodeSpec) -> [NodeSpec] { [node] }
  static func buildExpression(_ nodes: [NodeSpec]) -> [NodeSpec] { nodes }
  static func buildArray(_ components: [[NodeSpec]]) -> [NodeSpec] { components.flatMap { $0 } }
  static func buildOptional(_ component: [NodeSpec]?) -> [NodeSpec] { component ?? [] }
  static func buildEither(first component: [NodeSpec]) -> [NodeSpec] { component }
  static func buildEither(second component: [NodeSpec]) -> [NodeSpec] { component }
}
