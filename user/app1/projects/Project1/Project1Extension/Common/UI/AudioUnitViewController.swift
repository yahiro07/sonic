...
private let log = Logger(subsystem: "net.miqsel.synth2511.Project1Extension", category: "AudioUnitViewController")
	...
	*/
	...
	nonisolated public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
		return try DispatchQueue.main.sync {
			...
			audioUnit = try Project1ExtensionAudioUnit(componentDescription: componentDescription, options: [])
